...
import com.collabnest.backend.dto.task.AssignTaskRequest;
...
public class TaskController {
        ...
        /**
         * Assign a task to a user - requires MEMBER role.
         */
        ...
        public ResponseEntity<TaskResponse> assignTask(
                ...
                Task task = taskService.assignTask(taskId, request.userId());
                return ResponseEntity.ok(TaskResponse.fromEntity(task));
        }
}
